"""
FULL verbose Lal Kitab output for Meharban Singh Upneja — every
engine's complete narrative, nothing truncated. Output goes to
stdout AND to /tmp/lk_meharban_verbose.md for easy sharing.
...
def main():
    ...
    out_path = os.path.join(ROOT, "docs", "testing", "lk_meharban_verbose.md")
