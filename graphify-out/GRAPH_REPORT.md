...
## Corpus Check
- 522 files · ~5,286,050 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8034 nodes · 14180 edges · 274 communities detected
...
Cohesion: 0.02
Nodes (326): get_live_dashboard(), get_stats(), get_user_detail(), list_all_kundlis(), list_users(), Admin routes — user management, stats, kundli overview, live traffic panel., Change a user's role (user/astrologer/admin)., Activate or deactivate a user account. (+318 more)
...
- **Thin community `Community 213`** (2 nodes): `transit_interpretations.py`, `Transit interpretation fragments — 9 planets x 12 houses x 5 areas, bilingual.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 214`** (2 nodes): `__init__.py`, `Route registry — import all routers for inclusion in the FastAPI app.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `js()` connect `Community 7` to `Community 33`, `Community 4`, `Community 36`, `Community 12`?**
