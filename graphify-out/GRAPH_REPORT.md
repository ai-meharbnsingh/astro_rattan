...
## Corpus Check
- 542 files · ~5,403,406 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8467 nodes · 14806 edges · 284 communities detected
...
## Knowledge Gaps
- **2058 isolated node(s):** `Safely extract data from a key. Returns None if ok=False or missing.`, `Return error message for a failed key.`, `Return STATUS string for a key.`, `Lal Kitab remedy context — Sun, Moon, Mars (36 entries)`, `Tests for enhanced Choghadiya — Vaar Vela, Kaal Vela, Kaal Ratri flags.` (+2053 more)
