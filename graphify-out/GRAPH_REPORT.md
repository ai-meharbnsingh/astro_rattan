...
## Corpus Check
- 514 files · ~5,181,392 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7805 nodes · 13531 edges · 274 communities detected
...
Cohesion: 0.02
Nodes (246): get_analytics(), HitPayload, Analytics routes — lightweight page-view tracking and admin reporting., Record a single page view from the frontend SPA.     No auth required — called c, Aggregated traffic analytics for the admin panel., record_hit(), AstroMapRequest, list_available_cities() (+238 more)
...
Cohesion: 0.09
Nodes (63): get_live_dashboard(), get_stats(), get_user_detail(), list_all_kundlis(), list_users(), Admin routes — user management, stats, kundli overview, live traffic panel., Change a user's role (user/astrologer/admin)., Activate or deactivate a user account. (+55 more)
...
- **Thin community `Community 221`** (2 nodes): `KundliChart.jsx`, `KundliChart()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 222`** (1 nodes): `translate_script.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `js()` connect `Community 3` to `Community 34`, `Community 132`, `Community 10`, `Community 89`, `Community 92`, `Community 31`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `KPHoraryRequest` connect `Community 6` to `Community 24`, `Community 2`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `KPHoraryPredictRequest` connect `Community 6` to `Community 24`, `Community 2`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
