...
## Corpus Check
- 242 files · ~3,421,246 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2175 nodes · 3312 edges · 79 communities detected
...
Cohesion: 0.01
Nodes (35): apiFetch(), fetchWithRetry(), friendlyError(), tryRefreshToken(), handleOtpKeyDown(), handleResendOtp(), handleSendOtp(), handleVerifyOtp() (+27 more)
...
- **Why does `KundliRequest` connect `Community 4` to `Community 1`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `KundliMatchRequest` connect `Community 4` to `Community 1`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `DivisionalChartRequest` connect `Community 4` to `Community 1`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
