...
_Generated by AstroRattan.com_`;
  ...
  return (
    <section ref={sectionRef} id="panchang" className="relative py-8 bg-transparent">
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

        {/* Compact Header — single line */}
        <h2 className="text-2xl font-bold text-cosmic-text mb-4">
          {language === 'hi' ? 'दैनिक पंचांग' : 'Daily Panchang'}
        </h2>
