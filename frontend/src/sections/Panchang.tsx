...
import TodaysInsights from '@/components/panchang/TodaysInsights';
import QuickRecommendations from '@/components/panchang/QuickRecommendations';
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {panchang && (
          <div className="space-y-6 min-h-[400px]">
            ...
            <TodaysInsights panchang={panchang} language={language} t={t} currentTime={currentTime} />

            {/* Quick Recommendations */}
            <QuickRecommendations panchang={panchang} language={language} t={t} />
