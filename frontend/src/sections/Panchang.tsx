          ...
          <div className="space-y-4 min-h-[400px]">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              <TabsList className="flex w-full flex-wrap gap-1 h-auto p-1 bg-card rounded-xl">
                {[
                  { id: 'core', label: t('auto.core'), icon: AlignLeft },
                  ...
                  { id: 'monthly', label: t('auto.festivals'), icon: CalendarDays },
                ].map(tab => (
              ...
              <div className="mt-4">
                ...
                <TabsContent value="calendar">
                  <HinduCalendarTab language={language} t={t} latitude={latitude} longitude={longitude} />
                </TabsContent>
