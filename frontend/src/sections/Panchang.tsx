            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <div className="mt-2">
                <TabsContent value="calendar">
                  <HinduCalendarTab language={language} t={t} latitude={latitude} longitude={longitude} locationName={cityQuery || undefined} />
                </TabsContent>
                <TabsContent value="muhurat-finder">
                  <MuhuratFinderTab language={language} t={t} latitude={latitude} longitude={longitude} />
                </TabsContent>
                ...
                <TabsContent value="tarabalam">
                  <TarabalamTab panchang={panchang} language={language} t={t} />
                </TabsContent>
              </div>
            </Tabs>
          </div>
