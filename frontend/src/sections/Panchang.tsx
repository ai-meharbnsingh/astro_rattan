...
_Generated by AstroRattan.com_`;
  ...
  const dateDisplay = new Date(selectedDate + 'T12:00:00').toLocaleDateString(t('auto.enIN'), {
    weekday: 'long', year: 'numeric', month: 'long', day: 'numeric',
  });
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              <TabsList className="flex w-full flex-wrap gap-1 h-auto p-1 bg-card rounded-xl">
                {[
                  ...
                  { id: 'monthly', label: language === 'hi' ? 'मासिक ग्रिड' : 'Monthly Grid', icon: Calendar },
                  { id: 'core', label: language === 'hi' ? 'मुख्य विवरण' : 'Essentials', icon: Sun },
              ...
              <div className="mt-2">
                ...
                <TabsContent value="monthly">
                  {activeTab === 'monthly' && <MonthlyCalendarTab language={language} t={t} latitude={latitude} longitude={longitude} />}
                </TabsContent>
                <TabsContent value="core">
                  {activeTab === 'core' && panchang && <PanchangCoreTab panchang={panchang} language={language} t={t} />}
                </TabsContent>
                ...
                <TabsContent value="muhurat">
                  {activeTab === 'muhurat' && <MuhuratTab panchang={panchang} language={language} t={t} />}
                </TabsContent>
