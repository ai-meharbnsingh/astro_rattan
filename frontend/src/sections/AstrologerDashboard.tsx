    ...
    <section className="max-w-6xl mx-auto py-24 px-4">
      ...
      <Tabs defaultValue="consultations" className="w-full">
        <TabsList className="bg-cosmic-surface mb-6">
          <TabsTrigger value="consultations" className="data-[state=active]:bg-sacred-gold data-[state=active]:text-cosmic-bg">Consultations</TabsTrigger>
                  ...
                  <CardContent className="p-4">
                    <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                      ...
                      <div className="flex flex-wrap items-center gap-3">
                        ...
                        {c.status === 'requested' && (
                          <Button size="sm" onClick={() => acceptConsultation(c.id)} className="bg-sacred-gold text-cosmic-bg hover:bg-sacred-gold-dark">Accept</Button>
                        )}
