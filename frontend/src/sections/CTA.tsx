...
export default function CTA() {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-sacred-cream bg-mandala">
      <div className="absolute inset-0 z-0">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-sacred-gold/5 rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-sacred-saffron/5 rounded-full blur-3xl" />
      </div>
      <div className="relative z-10 cta-content max-w-4xl mx-auto px-4 text-center">
        ...
        <h2 className="text-4xl sm:text-5xl lg:text-6xl font-sacred font-bold text-sacred-brown mb-6">
          Ready to Meet Your<span className="block text-gradient-gold">Future?</span>
        </h2>
        <p className="text-lg text-sacred-text-secondary max-w-2xl mx-auto mb-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          ...
          <Button variant="outline" size="lg" className="border-sacred-gold text-sacred-brown text-lg px-8 py-6 hover:bg-sacred-gold/10">
            <Phone className="w-5 h-5 mr-2" />Talk to Expert
          </Button>
        </div>
        <div className="flex flex-wrap justify-center gap-6 text-sm text-sacred-text-secondary">
