    ...
    <section className="max-w-4xl mx-auto py-24 px-4">
      ...
      <Tabs value={activeTab} onValueChange={(v) => { setActiveTab(v); clearResult(); }}>
        <TabsList className="grid grid-cols-4 bg-cosmic-surface mb-8 max-w-lg mx-auto">
          <TabsTrigger value="ram-shalaka" className="data-[state=active]:bg-sacred-gold data-[state=active]:text-cosmic-bg text-xs sm:text-sm">Ram Shalaka</TabsTrigger>
          <TabsTrigger value="hanuman" className="data-[state=active]:bg-sacred-gold data-[state=active]:text-cosmic-bg text-xs sm:text-sm">Hanuman</TabsTrigger>
          <TabsTrigger value="gita" className="data-[state=active]:bg-sacred-gold data-[state=active]:text-cosmic-bg text-xs sm:text-sm">Gita</TabsTrigger>
          <TabsTrigger value="ramcharitmanas" className="data-[state=active]:bg-sacred-gold data-[state=active]:text-cosmic-bg text-xs sm:text-sm">Ramcharitmanas</TabsTrigger>
        </TabsList>
          ...
          <Card className="bg-cosmic-card border-0 shadow-soft max-w-xl mx-auto">
            <CardContent className="p-6">
              ...
              <div className="flex gap-2">
                ...
                />
                <Button onClick={() => handleOracle('/api/prashnavali/hanuman')} disabled={loading || !question.trim()} className="bg-sacred-gold text-cosmic-bg hover:bg-sacred-gold-dark">
            ...
            <CardContent className="p-6">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  className="flex-1 bg-cosmic-card border-sacred-gold/15"
                />
                <Button onClick={() => handleOracle('/api/prashnavali/gita')} disabled={loading || !question.trim()} className="bg-sacred-gold text-cosmic-bg hover:bg-sacred-gold-dark">
                  {loading ? <Loader2 className="w-4 h-4 animate-spin" /> : <Sparkles className="w-4 h-4" />}
                </Button>
              </div>
            </CardContent>
            ...
            <CardContent className="p-6">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  className="flex-1 bg-cosmic-card border-sacred-gold/15"
                />
                <Button onClick={() => handleOracle('/api/prashnavali/ramcharitmanas')} disabled={loading || !question.trim()} className="bg-sacred-gold text-cosmic-bg hover:bg-sacred-gold-dark">
                  {loading ? <Loader2 className="w-4 h-4 animate-spin" /> : <Sparkles className="w-4 h-4" />}
                </Button>
              </div>
            </CardContent>
