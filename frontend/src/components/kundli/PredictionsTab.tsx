...
export default function PredictionsTab({
  ...
  if (loadingPredictions) {
    return (
      <div className="flex items-center justify-center py-12">
        ...
        <span className="ml-2 text-sacred-text-secondary">Consulting the stars...</span>
      </div>
    );
  }
      ...
      <div className="space-y-4">
        <div className="rounded-2xl p-6 border" style={{ backgroundColor: '#F5F0E8', borderColor: 'rgba(139,115,85,0.2)' }}>
          <div className="flex items-center gap-3 mb-4">
            ...
            <h4 className="font-display font-semibold text-xl text-sacred-brown">AI Predictions</h4>
          ...
          <div className="max-w-none" style={{ color: '#1a1a2e' }}>
            {renderMarkdown(predictionsData.interpretation || predictionsData.response || predictionsData.text || 'Generating predictions...')}
  ...
  return (
    <div className="text-center py-12">
      ...
      <p className="text-sacred-text-secondary mb-4">Get AI Predictions</p>
      <Button onClick={onFetchPredictions} className="btn-sacred">
        <Sparkles className="w-4 h-4 mr-2" />Predictions
      </Button>
      {isPuterAvailable() && (
