...
export default function VideoSessionPanel({
  ...
  return (
    <Card className="bg-cosmic-surface border border-minimal-indigo/10 shadow-soft">
      <CardContent className="p-4 sm:p-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full bg-minimal-indigo/10 px-3 py-1 text-sm font-medium text-minimal-indigo">
            ...
            <p className="mt-2 text-sm text-minimal-gray-400">Room: {roomName}</p>
          </div>
