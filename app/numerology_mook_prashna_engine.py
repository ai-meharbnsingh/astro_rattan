...
KHOYI_VASTU_LOCATIONS: dict[int, dict] = {
    ...
    62: {
        ...
        "hint": "Look inside and around every water vessel in your home — the earthen pot, the pitcher, the jug, and any decorative water container. The item may have slipped in or been placed beside one. This is a positive sign: the item remains in your own home under your authority and will be found.",
        "hint_hi": "घर के हर पानी के बर्तन के अंदर और आसपास देखें — मटका, सुराही, जग और कोई भी सजावटी पानी का बर्तन। वस्तु अंदर फिसल गई या उसके पास रखी गई होगी। यह शुभ संकेत है: वस्तु आपके घर में ही है।",
    },
    63: {
        "location": "After police investigation it will be found",
        "location_hi": "पुलिस की तहकीकात के बाद मिल जाएगी",
        "hint": "This is a case that requires official help — file a police complaint or lost-and-found report. A formal investigation, even a routine one, will shake loose the information needed to locate the item. Do not delay the process; the sooner you report it, the better your chances of recovery.",
        "hint_hi": "इस मामले में आधिकारिक सहायता की जरूरत है — पुलिस की शिकायत या खोया-पाया रिपोर्ट दर्ज करें। एक औपचारिक जाँच, चाहे सामान्य ही हो, वस्तु का पता लगाने की जानकारी निकाल लेगी। देरी न करें।",
    },
    64: {
        "location": "Your faithful servant will track it down",
        "location_hi": "आपका वफादार नौकर उसका पता लगा देगा",
        "hint": "Trust the most loyal, long-serving helper in your household with this task. Give them the full description of the item and ask them specifically to find it. Their familiarity with every corner of your home, combined with their loyalty to you, makes them the most effective searcher available.",
        "hint_hi": "घर के सबसे वफादार और पुराने नौकर को यह काम सौंपें। उन्हें वस्तु का पूरा विवरण दें और खासतौर से इसे खोजने को कहें। घर के हर कोने की उनकी जानकारी और आपके प्रति उनकी वफादारी उन्हें सबसे प्रभावी खोजकर्ता बनाती है।",
    },
    65: {
        ...
        "hint": "The item is with a young person — a teenager or child who picked it up out of curiosity or during play. Ask them directly and do not be surprised if it comes back broken, bent, or damaged; young hands do not always treat things gently. Recovery is still possible, but prepare for some damage.",
        "hint_hi": "वस्तु किसी किशोर या बच्चे के पास है जिसने जिज्ञासावश या खेल में उठा ली। उनसे सीधे पूछें और अगर वह टूटी, मुड़ी या क्षतिग्रस्त होकर वापस आए तो आश्चर्यचकित न हों। मिलना संभव है लेकिन कुछ नुकसान की संभावना है।",
    },
    66: {
        ...
        "hint": "Go to the kitchen pantry and dry goods storage — where flour, spices, lentils, and grains are kept. Check on and between the canisters, inside the spice rack, behind the flour tin, and in any shelf or cabinet that holds dry provisions. The item is tucked in this practical, functional area of your home.",
        "hint_hi": "रसोई के भंडारगृह और सूखे सामान की जगह पर जाएं — जहाँ आटा, मसाले, दाल और अनाज रखे जाते हैं। डिब्बों के बीच, मसाला रैक के अंदर, आटे के डिब्बे के पीछे देखें। वस्तु घर के इस व्यावहारिक क्षेत्र में है।",
    },
    67: {
        "location": "A little far — some servant will bring it to you",
        "location_hi": "कुछ दूर पर है — कोई नौकर उसे लेकर आपके पास आएगा",
        "hint": "The item has travelled a short distance from where you last had it — it is nearby but not in your immediate space. You do not need to go looking; a domestic helper who moves between areas will come across it and bring it to you. Exercise a little patience and the item will make its way back on its own.",
        "hint_hi": "वस्तु आपके पास से थोड़ी दूर चली गई है — नजदीक है लेकिन सीधे आपके सामने नहीं। खोजने की जरूरत नहीं; कोई घरेलू सहायक जो इलाकों में आता-जाता है, इसे पाकर आपके पास ले आएगा। थोड़ा धैर्य रखें।",
    },
    68: {
        ...
        "hint": "The item is in a livestock area — near cows, bulls, or cattle sheds. Search that area physically, but go in with realistic expectations: the item may have been trampled, chewed, or damaged beyond use by the animals. Recovery is possible but chances are slim, and condition will likely be poor.",
        "hint_hi": "वस्तु पशु क्षेत्र में है — गाय, बैल या पशुशाला के पास। वहाँ शारीरिक रूप से खोजें, लेकिन यथार्थवादी अपेक्षाओं के साथ: वस्तु शायद पशुओं ने रौंदी हो, चबाई हो या क्षतिग्रस्त की हो। मिलना संभव है लेकिन संभावना कम है।",
    },
    69: {
        "location": "In your home, in iron or steel vessels",
        "location_hi": "आपके घर में — लोहे या स्टील के पात्रों में",
        "hint": "Search through every iron or steel container in your home — steel pots, iron boxes, metal canisters, stainless steel tins, and any metal storage vessel with a lid. Open each one and check inside. The item is in your home, within one of these metallic containers, and will be found once you search them all.",
        "hint_hi": "घर में हर लोहे या स्टील के बर्तन में खोजें — स्टील के बर्तन, लोहे के बक्से, धातु के डिब्बे, स्टेनलेस स्टील के टिन। हर एक खोलकर अंदर देखें। वस्तु घर में ही है, इनमें से किसी धातु के बर्तन में है।",
    },
    70: {
        "location": "In your clothes or covering — will be found",
        "location_hi": "पहनने, ओढ़ने के कपड़ों में — मिल जाएगी",
        "hint": "Search through all your clothing and bed coverings systematically — check the pockets of every garment, shake out folded clothes, unfold blankets and quilts, and check inside bed sheets and pillowcases. The item has slipped into or been wrapped up in fabric. This is a positive number — it will definitely be found.",
        "hint_hi": "सभी कपड़ों और बिस्तर के आवरणों में व्यवस्थित रूप से खोजें — हर कपड़े की जेबें जाँचें, मुड़े कपड़े झाड़ें, कम्बल और रजाई खोलें, चादरों और तकिए के खोल में देखें। वस्तु कपड़े में फंसी या लिपटी है। यह मिलेगी।",
    },
    71: {
        ...
        "hint": "The item is in or around the dining area of the kitchen — on the table where meals are eaten, near the serving area, or in a nearby drawer. Ask the cook or the person who prepares and serves food; they were in that space and likely saw the item. Keep watching the area — the item may reappear during the next meal preparation.",
        "hint_hi": "वस्तु रसोई के भोजन क्षेत्र में या उसके आसपास है — खाने की मेज पर, परोसने की जगह के पास, या पास की दराज में। रसोइये से पूछें; वे उस जगह थे और शायद वस्तु देखी होगी। उस क्षेत्र पर नजर रखें।",
    },
    72: {
        ...
        "hint": "A young unmarried woman in or near your household — a daughter, a niece, a younger sister, or a neighbour girl — either has the item or knows exactly where it is. Approach her warmly and ask specifically; her knowledge of household spaces and her sharp observation will lead you directly to what you are looking for.",
        "hint_hi": "घर में या पास में कोई युवती — बेटी, भतीजी, छोटी बहन या पड़ोस की लड़की — के पास वस्तु है या वह ठीक जानती है कि यह कहाँ है। उससे गर्मजोशी से और खासतौर से पूछें।",
    },
    73: {
        ...
        "hint": "The item is at home, safely stored inside a closed container. Go through your boxes, trunks, suitcases, and especially any two-part or divided containers such as tiffin carriers or stacked lunch boxes. Open each one and check both inside compartments. The item is secure and nearby — just waiting to be found.",
        "hint_hi": "वस्तु घर में ही किसी बंद बर्तन में सुरक्षित रखी है। बक्सों, संदूकों, सूटकेसों और खासकर दो भागों वाले बर्तनों जैसे टिफिन कैरियर में देखें। हर एक खोलकर दोनों खानों में जाँचें।",
    },
    74: {
        "location": "Your faithful servant will track it down",
        "location_hi": "आपका वफादार नौकर उसका पता लगा देगा",
        "hint": "Assign the search to the most trustworthy and experienced helper in your home — the one who has served you longest and knows every corner of the household. Give them a clear description and the authority to investigate fully. Their deep familiarity with the space and their loyalty to you will succeed where your own search has not.",
        "hint_hi": "घर के सबसे विश्वसनीय और अनुभवी नौकर को खोज का काम सौंपें — जो सबसे लंबे समय से आपकी सेवा कर रहा है। उन्हें स्पष्ट विवरण और पूरी तरह जाँच करने का अधिकार दें।",
    },
    75: {
        "location": "In young people's or children's hands — found in damaged condition",
        "location_hi": "नवयुवकों या बालकों के हाथ में — क्षत-विक्षत हालत में मिलेगी",
        "hint": "A young person in your household — a child or teenager — has had this item and has not told you. When you find it or it is returned, be prepared for some damage; young people are not always careful with things they borrow or pick up. Ask each young person calmly and without accusation to get honest answers quickly.",
        "hint_hi": "घर के किसी युवा व्यक्ति — बच्चे या किशोर — के पास यह वस्तु है और उन्होंने नहीं बताया। जब मिले तो कुछ नुकसान के लिए तैयार रहें। हर युवा से शांति से और बिना आरोप लगाए पूछें।",
    },
    76: {
        ...
        "hint": "Go directly to your kitchen pantry and dry goods storage area. Systematically check every shelf and shelf unit — around flour containers, spice boxes, grain jars, and lentil tins. The item is in this area of the home, mixed among the practical provisions of daily cooking. A methodical search will yield it.",
        "hint_hi": "सीधे रसोई के भंडारगृह और सूखे सामान की जगह पर जाएं। हर शेल्फ को व्यवस्थित रूप से जाँचें — आटे के डिब्बों, मसाले के बक्सों, अनाज के जारों के आसपास। वस्तु रसोई के इस व्यावहारिक क्षेत्र में है।",
    },
    77: {
        "location": "A little far — some servant will bring it to you",
        "location_hi": "कुछ दूर पर — कोई नौकर उसे लेकर आपके पास आएगा",
        "hint": "The item has moved a short distance from you — it is close but outside your immediate surroundings. You will not need to search yourself; a servant or helper who circulates through the household will encounter it in the course of their work and bring it back to you. Patience is the only action required from you right now.",
        "hint_hi": "वस्तु आपसे थोड़ी दूर चली गई है — नजदीक है लेकिन आपके तत्काल परिवेश से बाहर। आपको खुद खोजने की जरूरत नहीं; कोई नौकर या सहायक जो घर में घूमता है, काम करते समय इसे पाएगा और वापस लाएगा।",
    },
    78: {
        ...
        "hint": "The item is in or near a livestock area but the prognosis is very poor — it has likely been destroyed, trampled, or ruined beyond repair by the animals. If you wish to check, do visit the cattle shed or barn, but go without expectation. Accepting this loss and moving on is the more practical course of action.",
        "hint_hi": "वस्तु पशु क्षेत्र में या उसके पास है लेकिन संभावना बहुत कम है — शायद जानवरों द्वारा नष्ट, रौंदी या खराब हो चुकी है। यदि जाँचना चाहें तो पशुशाला या अस्तबल देखें, लेकिन बिना अपेक्षा के। हानि स्वीकार करना अधिक व्यावहारिक है।",
    },
    79: {
        "location": "In your home, in iron or steel vessels",
        "location_hi": "आपके घर में — लोहे या स्टील के पात्रों में",
        "hint": "The item is resting inside a metal container somewhere in your home. Check every iron or steel vessel — large cooking pots, steel storage boxes, iron trunks, metal canisters, and any lidded metalware. Lift the lids and look inside each one; the item is there within your home waiting to be discovered.",
        "hint_hi": "वस्तु घर में कहीं किसी धातु के बर्तन के अंदर है। हर लोहे या स्टील के बर्तन की जाँच करें — बड़े खाना पकाने के बर्तन, स्टील के भंडारण बक्से, लोहे के संदूक, धातु के डिब्बे। हर एक का ढक्कन उठाकर अंदर देखें।",
    },
    80: {
        ...
        "hint": "Search through your clothing and coverings first — shake out garments, check pockets, unfold blankets. Then turn to two-compartment storage like shoe boxes with inner trays or divided cases. Also literally check inside shoes and inside pairs of socks — small items often end up in footwear without anyone noticing.",
        "hint_hi": "पहले कपड़ों और आवरणों में खोजें — कपड़े झाड़ें, जेबें जाँचें, कम्बल खोलें। फिर दो खानों वाले भंडारण जैसे जूते के डिब्बे या विभाजित केस देखें। जूतों के अंदर और मोजों के जोड़ों में भी देखें।",
    },
    81: {
        "location": "In the kitchen where food is eaten — ask the cook; keep watch",
        "location_hi": "रसोई में खाना खाने के स्थान पर — रसोईये से पूछो; निगाह रखो",
        "hint": "The item is in the kitchen's eating or serving zone — on the dining table, near the serving counter, or in a nearby drawer. Ask the cook specifically and watch the area during the next meal. Items placed here during food preparation often get shifted and forgotten. A watchful eye combined with a direct question to the cook is your best strategy.",
        "hint_hi": "वस्तु रसोई के खाने या परोसने के क्षेत्र में है — डाइनिंग टेबल पर, परोसने के काउंटर के पास, या पास की दराज में। रसोइये से सीधे पूछें और अगले खाने के दौरान उस क्षेत्र पर नजर रखें।",
    },
    82: {
        ...
        "hint": "A young, unmarried woman in your home or immediate circle — a daughter, niece, younger sister, or young neighbour — is the key to finding this item. She either has it in her possession or can direct you to its location. Ask her warmly and she will help you; her sharp observation and natural helpfulness make her your most valuable ally in this search.",
        "hint_hi": "घर में या आपके करीबी दायरे में कोई युवती — बेटी, भतीजी, छोटी बहन, या युवा पड़ोसन — इस वस्तु को खोजने की कुंजी है। उसके पास वस्तु है या वह बता सकती है। गर्मजोशी से पूछें।",
    },
    83: {
        ...
        "hint": "Search two places: first, go through all closed storage — boxes, trunks, suitcases, and any two-part vessel such as a tiffin carrier or divided container. Second, check outside near any water-filled pit, tank, or large vessel. The item is in one of these two distinct zones and a thorough search of both will uncover it.",
        "hint_hi": "दो जगह खोजें: पहले, सभी बंद भंडारण — बक्से, संदूक, सूटकेस और किसी दो भागों वाले बर्तन जैसे टिफिन कैरियर में। दूसरे, बाहर किसी पानी से भरे गड्ढे, टंकी या बड़े बर्तन के पास। दोनों क्षेत्रों की अच्छी तरह खोज से मिलेगी।",
    },
    84: {
        ...
        "hint": "Check your closed storage containers — boxes, trunks, and cases inside the home. If not found there, go outside and search near any pond, water tank, or water-filled pit in the vicinity. Both are strong candidates and a careful search of each will bring the item to light. End your search on an optimistic note — this number is generally auspicious.",
        "hint_hi": "बंद भंडारण बर्तनों की जाँच करें — घर के अंदर बक्से, संदूक और केस। वहाँ नहीं मिले तो बाहर जाएं और आसपास के किसी तालाब, पानी की टंकी या पानी से भरे गड्ढे के पास खोजें। यह अंक आम तौर पर शुभ है — आशावादी रहें।",
    },
}
