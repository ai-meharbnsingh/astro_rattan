...
_OCR_KEYWORDS: list[tuple[str, str]] = [
    ...
    ("bedroom 4",           "children_bedroom"),
    ("bedroom 5",           "children_bedroom"),
    ("bedroom 6",           "children_bedroom"),
    ("bed room 2",          "children_bedroom"),
    ("bed room 3",          "children_bedroom"),
    ("bed room 4",          "children_bedroom"),
    ("bed room 5",          "children_bedroom"),
    ("bed room 6",          "children_bedroom"),
    ("room 2",              "children_bedroom"),
    ("room 3",              "children_bedroom"),
    ("room 4",              "children_bedroom"),
    ("room 5",              "children_bedroom"),
    ("room 6",              "children_bedroom"),
    ("bedroom",             "master_bedroom"),
    ("bed",                 "master_bedroom"),
    ("children",            "children_bedroom"),
    ("child",               "children_bedroom"),
    ("kids",                "children_bedroom"),
    # Bathroom / WC — numbered variants first
    ("bathroom 1",          "bathroom"),
    ("bathroom 2",          "bathroom"),
    ("bathroom 3",          "bathroom"),
    ("toilet 1",            "bathroom"),
